...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post donors_url, params: { donor: { email: @donor.email, first_name: @donor.first_name, index: @donor.index, last_name: @donor.last_name, phone_number: @donor.phone_number } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { email: @donor.email, first_name: @donor.first_name, index: @donor.index, last_name: @donor.last_name, phone_number: @donor.phone_number } }

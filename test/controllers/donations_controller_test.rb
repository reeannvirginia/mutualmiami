...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { Donor_id: @donation.Donor_id, amount: @donation.amount } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { Donor_id: @donation.Donor_id, amount: @donation.amount } }
